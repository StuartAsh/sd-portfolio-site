...
function TodoApp() {
  ...
  useLayoutEffect(() => {
    ...
    const originalViewport = metaViewport
  ...
  const handleAddTodo = (todo: string) => {
    ...
    if (
      currentList.todos.some((t) => t.text.toLowerCase() === todo.toLowerCase())
    ) {
              ...
              <div className="todo-list-header">
                <h2 className="list-title-container">
                  ...
                  <button
                    ...
                    onClick={() => {
                      const filteredTodos = currentList.todos.filter(
                        (todo) => !todo.completed
                      );
